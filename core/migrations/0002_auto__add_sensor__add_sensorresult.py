...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_sensorresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sensor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='results', to_field='pid', to=orm['core.Sensor'])),
            ('car', self.gf('django.db.models.fields.related.ForeignKey')(related_name='results', to=orm['core.Car'])),
        ...
        db.send_create_signal(u'core', ['SensorResult'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'core_sensorresult')
