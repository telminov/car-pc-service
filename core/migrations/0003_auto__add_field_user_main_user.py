...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.main_user'
        db.add_column(u'core_user', 'main_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='car_users', null=True, to=orm['core.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.main_user'
        db.delete_column(u'core_user', 'main_user_id')
